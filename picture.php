...
<?php
	...
	if(isset($_GET['page'])){
		if($_GET['page'] <= $_SESSION['pic_total_page'] && $_GET['page'] > 0){
			$page = $_GET['page'];
		}
		else{
	...
	$page_sql = "select big_path from picture_lab limit $offer,$page_size";
	...
	$_SESSION['pic_total_page'] = $total_page;
	    	...
	    	<div id="header">
                ...
                <div id="menu_wrap">
                    <ul id="menu">
                        ...
                        <li><a href="picture.php" title="My Picture" class="current">图库</a></li>
				...
				?>
                      <div class="row">
                            <div class="work_image">
                                <a href="<?php echo $value[0]['big_path']?>"><img src="<?php echo $value[0]['big_path']?>" width="100%" alt="Sample Image"/></a>
                            </div>
                          <div class="work_desc">
                          <?php 
							  if(!empty($value[1]['big_path'])){
								  ?>
                              <div class="work_image">
							  
                                <a href="<?php echo $value[1]['big_path']?>"><img src="<?php echo $value[1]['big_path']?>" width="100%" alt="Sample Image"/></a>
